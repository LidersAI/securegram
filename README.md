...
## Актуальные UI-обновления (v7)

Чтобы изменения были видны сразу в браузере:

- включён version-marker в интерфейсе: `build v7` (под вашим ID в сайдбаре);
- обновлён Service Worker cache key до `liders-v7`;
- регистрация SW идёт с версией `sw.js?v=7`, чтобы форсировать обновление кэша.

Недавние UX-изменения:

- красная кнопка **Panic** в тулбаре;
- экран первого входа + пустой главный экран с пометкой **эксклюзивный ранний доступ**;
- ссылка на сайт проекта: https://liderschat.online/
